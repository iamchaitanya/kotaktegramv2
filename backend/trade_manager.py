...
class TradeManager:
    ...
    async def process_message(self, text: str, sender: str = "", timestamp: str = ""):
        ...
        # [1] Consolidated pending-order replacement (removed dead _cancel_pending_duplicate method)
    ...
    async def resubscribe_recent_signals(self, limit: int = 20):
        ...
        subs_count = 0  # [8] Plain int — no redundant int() casts needed
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            # [2] Included here so all callers (WS init, kill switch, REST) get consistent data
            "lot_size": self.lot_size,
            "strategy": self.strategy,
        }
